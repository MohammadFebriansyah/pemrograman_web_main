...
<body>
    ...
    <div class="hero">
        <h2>Selamat Datang di Page Admint</h2>
        <p>Tambahkan dan Edit Artikel Untuk USER Tercinta</p>
    </div>

    <div class="container">
        <h2 style="color: #132440; margin-bottom: 10px">Artikel Terbaru <a href="tambahArtikel.php"
            style="background-color: #000000; color: white; padding: 10px 12px; text-decoration: none; border-radius: 100%; font-size: 20px; font-weight: bold;">
            +
        </a></h2>
                        ...
                        <div class="article-card-content">
                            ...
                            <div style="margin-top: 15px;">
                                <a href="edit.php?id=' . $row["id"] . '"
                                    style="background-color: #28a745; color: white; padding: 8px 15px; text-decoration: none; border-radius: 3px; margin-right: 10px;">
                                    Edit Artikel
                                </a>
